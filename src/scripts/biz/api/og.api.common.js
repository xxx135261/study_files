...
$.register_module({
    ...
    obj: function () {
        ...
        common = {
            ...
            addFormData: function (formData, key, value) {
            ...
            /**
             * 将og.api.rest中request返回的Deferred对象转换成Promise
             *
             * @param jqueryDeferred
             * @return {Promise<any>}
             */
            transformToPromise: function (jqueryDeferred) {
                return new Promise((resolve, reject) => {
                   jqueryDeferred.done(result => {
                       if (result.error) {
                           reject();
                       } else {
                           resolve(result.data);
