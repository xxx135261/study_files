 ...
 */
$.register_module({
    name: 'com.hundsun.pas.api.common',
    dependencies: [],
    obj: function () {
        var module = this, common, warn = com.hundsun.pas.dev.warn, MAX_INT = Math.pow(2, 31) - 1, PAGE = 1, PAGE_SIZE = 50,
        ...
        var check_required = function (bundle, params) {
            ...
            var exists = function (val) {
                return !!str(bundle.config[val]);
            }; // makes sure values are not empty
            ($.isArray(params) ? params : [params]).forEach(function (obj) {
        ...
        common = {
            cache_clear: function (prefix) {
                try { // if cache is restricted, bail
                    ...
                    Object.keys(cache).forEach(function (key) {
                        if (key.indexOf(prefix) === 0) common.cache_del(key);
                    });
                } catch (error) {
            ...
            cache_get: function (key) {
                ...
                try {
                    ...
                    return warn(module.name + ': cache_get failed\n', error), null;
                }
            },
            ...
            Promise: function () {
                ...
                promise.abort = function () {
                    return og.api.rest.abort(promise), promise;
                };
