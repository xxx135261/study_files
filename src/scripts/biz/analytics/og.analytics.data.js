    ...
    obj: function () {
        ...
        var ConnectionPool = new function () {
            ...
            pool = {
                ...
                parent : function (data) {
                    var parent, source = Object.assign({}, data.source);
                    if (data.pool) {
                        return null;
                    }
        ...
        var Data = function (source, config) {
            var data = this, api = og.api.rest.views, meta, label = config.label ? config.label + '-' : '',
                ...
                bypass_types = config.bypass, structure_promise, killed = false;
            ...
            var initialize = function () {
                var put_options = ['viewdefinition', 'aggregators', 'aggDefUniqueId', 'portfolio', 'providers','valuation', 'version', 'correction',
