...
$.register_module({
    ...
    obj: function () {
        ...
        var init = function (data) {
            ...
            if (data.benchId) temporal.benchId = data.benchId;
            if (data.calcTimeParam) temporal.calcTimeParam = data.calcTimeParam;
        ...
        var load_form = function (data) {
            var query = {
                ...
                benchId: data.temporal.benchId,
                calcTimeParam: data.temporal.calcTimeParam
            };
