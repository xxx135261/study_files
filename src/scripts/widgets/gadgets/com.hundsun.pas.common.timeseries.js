 ...
 */
$.register_module({
    name: 'com.hundsun.pas.common.Timeseries',
    ...
    obj: function () {
        ...
        return function (config) {
            ...
            handler = function (result) {
                ...
                if (!config.child) com.hundsun.pas.common.gadgets.manager.register(timeseries);
                timeseries.resize();
            };
            var tmpl="<div class=\"OG-timeseries\">\n" +
                "  <section class=\"og-plots {{alive}}\">\n" +
                "    <div class=\"og-flot-top\"></div>\n" +
                "    <div class=\"og-plot-header\"></div>\n" +
                "    <div class='og-timeseries-refresh OG-link'>Refresh</div>\n" +
                "    <div class=\"og-timeseries-plot og-js-timeseries-plot\">\n" +
                "      <div class=\"og-js-p1\"></div>\n" +
                "      <div class=\"og-flot-xaxis\"></div>\n" +
                "      <div class=\"og-js-p2-background\"></div>\n" +
                "      <div class=\"og-js-p2\"></div>\n" +
                "      <div class=\"og-tenor\"></div>\n" +
                "    </div>\n" +
                "  </section>\n" +
                "  <section class=\"og-loading\">loading...</section>\n" +
                "</div>";
